...
# There will be a button to show errors.
# Buttons:
# For mode 1, show next step, show previous step, show original, show final like Chess.com game review. 
# For mode 2, solve, reset, hint, check, new puzzle buttons.
# Timer only for mode 2.
# Difficulty on mode 2 like on NYT.
...
# Mode 1 game screen:
# Input field for 81-char string
# 9x9 board display
# Step back / Step forward / Show original / Show final buttons
# Current strategy being used displayed
# Mode 2 game screen:
# Difficulty selector (Easy/Medium/Hard/Evil)
# 9x9 board
# Timer
# Solve / Reset / Hint / Check / New Puzzle buttons
